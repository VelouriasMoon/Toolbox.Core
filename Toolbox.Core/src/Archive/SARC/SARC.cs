...
namespace Toolbox.Core.Archive
{
    public class SARC : IFileFormat, IArchiveFile
    {
        ...
        public SARC(bool LittleEndian = false, bool Hashonly = false)
        {
            SarcData = new SarcData()
            {
                Files = new Dictionary<string, Stream>(),
                endianness = LittleEndian ? Syroot.BinaryData.ByteOrder.LittleEndian : Syroot.BinaryData.ByteOrder.BigEndian,
                HashOnly = Hashonly
            };
        }
